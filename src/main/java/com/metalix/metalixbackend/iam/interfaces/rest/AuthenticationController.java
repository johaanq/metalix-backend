...
public class AuthenticationController {
    ...
    @PostMapping("/register-municipality")
    @Operation(summary = "Register a new municipality with admin user")
    public ResponseEntity<AuthenticationResponse> registerMunicipality(
            @Valid @RequestBody RegisterMunicipalityRequest request
    ) {
        return ResponseEntity.ok(authenticationService.registerMunicipality(request));
    }
